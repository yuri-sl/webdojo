...
Cypress.Commands.add("login", (ui = false) => {
    ...
    if (ui === true) {
        ...
        //Atalho para deixar a parte de login mais rápido.
        //Injeta o Cookie na página de Login através da autenticação.
...
Cypress.Commands.add("validadeConsultancyModal", () => {
    cy.contains(
        "Sua solicitação de consultoria foi enviada com sucesso! Em breve, nossa equipe entrará em contato através do email fornecido.", { timeout: 6000 }
    ).should("be.visible");
});